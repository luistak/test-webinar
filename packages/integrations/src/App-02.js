...
const Details = ({ onAddToCart, itemId } ) => {
  const { items = [] } = useContext(EcommerceContext);
...
function Checkout({ onCartItemChange, onClearCart }) {
    ...
    <ErrorBoundary>
      <div className="app">
        <EcommerceContext.Provider value={{
          ...
          <Router>
            <Details path="/item/:itemId" onAddToCart={handleCartItemChange} />
            <Checkout path="/checkout" onCartItemChange={handleCartItemChange} onClearCart={handleClearCart}/>
            <Home path="/" />
          </Router>
